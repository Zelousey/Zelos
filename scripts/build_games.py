...
(function(){
  ...
  <section class="zg-panel">
    ...
    <div id="zrPlay">
      ...
      so a loss at your stop is no longer a fixed 0.5&ndash;2%; it can be many times that. Real traders almost never do this. In Full Port there are
      <b>no hints</b>, and <b>Auto-play only unlocks once you're in a trade</b>: before that, Wait is the only way to see ahead. Each Full Port trade costs <b>25 discipline points</b>, each <b>Wait</b> costs 10, and discipline
  ...
  <section class="zg-howto">
    ...
    with your account, there are no hints, Auto-play only runs while you're in a trade, and every Wait costs 10 discipline points on top
    of the 25 each Full Port trade costs.</p>
