  ...
  <div class="pt-grid">
    ...
    <section class="pt-card pt-main" aria-label="Chart">
      ...
      <div class="pt-toolbar">
        <button class="pt-chip" type="button" data-range="21">1M</button>
        <button class="pt-chip" type="button" data-range="63">3M</button>
        <button class="pt-chip is-on" type="button" data-range="126">6M</button>
        <button class="pt-chip" type="button" data-range="252">1Y</button>
        <button class="pt-chip" type="button" data-range="all">All</button>
